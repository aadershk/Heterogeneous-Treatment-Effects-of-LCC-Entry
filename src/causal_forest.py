...
QUARTILE_DIMS = [
    # Quartile groups are labelled G1-G4 so they cannot be confused with
    # calendar quarters (Q1-Q4), which the study reserves for time periods.
    ("HHI_pre", "HHI_quartile", "HHI", ["G1 (Low)", "G2", "G3", "G4 (High)"]),
    ("log_Dist", "Dist_quartile", "Distance", ["G1 (Short)", "G2", "G3", "G4 (Long)"]),
    ("log_Pax_pre", "Pax_quartile", "Passenger Density", ["G1 (Low)", "G2", "G3", "G4 (High)"]),
]
